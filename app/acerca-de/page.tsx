...
const HIGHLIGHTS: { i: "HEART" | "BROWSER" | "PLANT"; t: string; c: "cyan" | "magenta" | "green" }[] = [
            ...
            {status === "idle" || status === "sending" ? (
              ...
              <div className="terminal-success is-error">
                ...
                <div className="term-body">
                  ...
                  <div className="line dim">[OK] Conectando con servidor…</div>
                  <div className="line dim">[FAIL] No se pudo transmitir el paquete.</div>
                  <div className="line success">
                    &gt; ERROR AL ENVIAR EL MENSAJE. INTENTÁ DE NUEVO.<span className="caret">_</span>
                  </div>
                  <div style={{ marginTop: 18 }}>
