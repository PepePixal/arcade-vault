...
import { GAMES, HOME_STATS, RECENT_ACTIVITY, TOP_PLAYERS_TODAY, type Game } from "@/lib/data";
...
const FEATURES: { i: "GAMEPAD" | "FREE" | "TROPHY" | "ROCKET"; t: string; d: string; c: "cyan" | "yellow" | "magenta" | "green" }[] = [
  {
    i: "GAMEPAD",
    t: "JUEGOS CLÁSICOS",
  ...
  return (
    <div className="home fade-in">
      ...
      <section className="home-hero">
        ...
        <div className="home-hero-inner">
          ...
          <div className="home-ctas">
            <button className="btn xl pulse" onClick={() => router.push("/juego")}>
              ▶ EXPLORAR JUEGOS
            </button>
      ...
      <section className="home-final reveal">
        ...
        <button className="btn xl pulse final-cta" onClick={() => router.push("/juego")}>
          INSERTAR MONEDA →
        </button>
